                ...
                <div className="max-w-md mx-auto">
                    ...
                    <div className="divide-y divide-gray-200">
                        <form onSubmit="#" className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                            ...
                            <p>If you have an account, Plese <Link to="/login" className='text-blue-600 underline hover:text-blue-800'>Login</Link></p>
                            <div className="relative">
                                <button className="bg-blue-500 text-white rounded-md px-5 py-1 hover:bg-blue-700">Submit</button>
                            </div>
                        </form>
                    </div>
                </div>
