  ...
  return (
    <div className='px-4 lg:px-24 my-20 flex flex-col md:flex-row justify-between items-center gap-12'>
        ...
        <div className='md:w-1/2 space-y-6'>
            ...
            <p className='mb-10 text-lg md:w-5/6'>You can find books of any types of your want. We have anything you are looking for. From novels and short stories to articles and educational books, you can have them all in your hands with just a single click.</p>
            {/*stats*/}
